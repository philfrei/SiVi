...
public class TemplateCard extends JPanel
{
	...
	public TemplateCard (int width, int height, final TutorialFramework tf)
	{
		setLayout(null);
		...
		NavigationPanel np = new NavigationPanel(tf, 
				"Title Card", "Title Card", "Simplex Card");
